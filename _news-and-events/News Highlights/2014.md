...
<table style="margin: auto; outline: 0px; padding: 0px; border-collapse: collapse; clear: both; border: 1px solid transparent; table-layout: fixed; width: 680px;" class="ive_eobj_center ives_tab_kosong"><tbody style="margin: 0px; outline: 0px; padding: 0px;"><tr style="margin: 0px; outline: 0px; padding: 0px;"><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 387px;"><img style="margin: 0px 10px 0px 0px; outline: none; padding: 0px; border: none; float: left; cursor: pointer; width: 401px; height: 190px;" class="ive_clickable ive_eobj_left" alt="B Singles Jinjie (Cat High).jpg" src="![](/images/B%20Singles%20Jinjie%20(Cat%20High).jpeg)"></td><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 293px;"><img style="margin: 0px 10px 0px 0px; outline: none; padding: 0px; border: none; float: left; cursor: pointer; width: 307px; height: 192px;" class="ive_eobj_left ive_clickable" alt="C Singles Alistair.jpg" src="![](/images/C%20Singles%20Alistair.jpeg)"></td></tr></tbody></table>
